...
public class ControllerAdvisorCategory {
    ...
    public ResponseEntity<Map<String, String>> handleTheNameCannotBeEmpty(
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(Collections.singletonMap(MESSAGE, ExceptionConstantsCategory.THE_NAME_CANNOT_BE_EMPTY.getMessage()));
    }
    ...
    public ResponseEntity<Map<String, String>> handleTheDescriptionCannotBeEmpty(
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(Collections.singletonMap(MESSAGE, ExceptionConstantsCategory.THE_DESCRIPTION_CANNOT_BE_EMPTY.getMessage()));
    }
