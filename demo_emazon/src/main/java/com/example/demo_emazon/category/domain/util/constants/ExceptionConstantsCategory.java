package com.example.demo_emazon.category.domain.util.constants;

public enum ExceptionConstantsCategory {

    CATEGORY_ALREADY_EXIST("The name of category already exist:"),
    ...
    ExceptionConstantsCategory(String message){
